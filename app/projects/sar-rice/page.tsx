...
export default function SARRicePage() {
    return (
                    ...
                    <div className="lg:col-span-12 mb-8">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/5 text-primary text-[10px] font-mono tracking-widest mb-6 uppercase">
                                <Info className="w-3 h-3" /> System_Analysis: SAR-Rice_v1.0
                            </div>
                            ...
                            <p className="text-lg md:text-xl text-muted-foreground max-w-4xl leading-relaxed italic border-l-4 border-primary/20 pl-6 mb-8">
                                "Automating rice paddy detection in Niigata, Japan using Sentinel-1 SAR time-series and Object-Based Image Analysis (OBIA). A robust framework for phenological pattern recognition and large-scale agricultural monitoring."
                            </p>
                        </motion.div>
                    </div>
                    ...
                    >
                        <div className="relative aspect-video rounded-xl overflow-hidden border border-white/10 bg-black/40 shadow-2xl group">
                            ...
                            <div className="absolute top-4 right-6 font-mono text-[10px] text-primary/60 pointer-events-none uppercase tracking-widest">
                                Analysis_Temporal_Feed
                            </div>
                        </div>

                        {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                { label: "Sensor_Data", value: "Sentinel-1 SAR" },
                                { label: "Methodology", value: "OBIA (LSMS)" },
                    ...
                    >
                        <div className="glass-card p-8 rounded-xl border border-white/10 relative overflow-hidden group">
                            ...
                            <ul className="space-y-4 font-mono text-xs">
                                {[
                                    ...
                                    "Multitemporal Feature Stack",
                                    "OBIA Large-Scale Segmentation",
                                    "Random Forest Classification",
                                    "Validation against JAXA LU Map",
                                    "Vector Boundary Generation"
                                ].map((feature, i) => (
                        ...
                        <div className="p-6 rounded-xl border border-dashed border-white/10 bg-white/[0.02]">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Sentinel-1", "OBIA", "Random Forest", "QGIS", "SNAP", "Orfeo ToolBox"].map(tech => (
