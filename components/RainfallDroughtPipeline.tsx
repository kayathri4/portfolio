...
export default function RainfallDroughtPipeline() {
    return (
            ...
            <div className="flex flex-col md:flex-row items-stretch justify-between gap-2 p-3 rounded bg-white/5 border border-white/5 font-mono text-[9px]">
                ...
                <div className="flex-1 flex flex-col gap-2 min-w-0">
                    ...
                    <ul className="flex flex-col gap-1.5 text-white/70">
                        <li className="flex items-start gap-1.5">
                            ...
                            <span>ECMWF seasonal rainfall</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>CHIRPS satellite rainfall</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                ...
                <div className="flex-1 flex flex-col gap-2 min-w-0">
                    ...
                    <ul className="flex flex-col gap-1.5 text-white/70">
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>Spatial & temporal alignment of Satellite data</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>Comparative validation of ECMWF against CHIRPS and Ground data</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>SPI computation</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="flex-1 flex flex-col gap-2 min-w-0">
                    ...
                    <ul className="flex flex-col gap-1.5 text-white/70">
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>Rainfall forecast skill metrics</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                            <span className="text-primary/50 mt-[2px]">&gt;</span>
                            <span>SPI-based drought forecasts</span>
                        </li>
                    </ul>
                </div>
